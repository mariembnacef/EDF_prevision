...
# edf_energy_forecast documentation build
...
from edf_energy_forecast import __version__ as release

# -- Project information -----------------------------------------------------

project = "edf_energy_forecast"
author = "Kedro"
...
htmlhelp_basename = "edf_energy_forecastdoc"
...
latex_documents = [
    (
        master_doc,
        "edf_energy_forecast.tex",
        "edf_energy_forecast Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "edf_energy_forecast",
        "Project edf_energy_forecast codebase.",
        "Data-Science",
    )
]
